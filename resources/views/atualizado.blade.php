...
<head>
    ...
    <link rel="canonical" href="http://localhost/Final/projeto/resources/views/atualizado.blade.php" />
    <link rel="shortlink" href="http://localhost/Final/projeto/resources/views/atualizado.blade.php" />
    <meta property="og:site_name" content="atualizado" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="pt_BR" />
    <meta property="og:url" content="http://localhost/Final/projeto/resources/views/atualizado.blade.php" />
    ...
    <meta name="twitter:url" content="http://localhost/Final/projeto/resources/views/atualizado.blade.php" />
    ...
    <meta name="dcterms.identifier" content="http://localhost/Final/projeto/resources/views/atualizado.blade.php" />
                        ...
                        <div class="teste">
                            ...
                            <section>
                                ...
                                <table id="pessoa" class="table-responsive">
                                    <tr>
                                        <td>Você foi atualizado com sucesso clique no botão abaixo para ver a listagem</td>
                                    </tr>
                                </table>

                            </section><br>
                            <a href="../mostra"><button>Voltar</button></a>
                        </div>
                    </div>
                </div>
            </div>
